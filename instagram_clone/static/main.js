...
const post_list = (id, user_img, author_id, img, liked, likes, author, no_of_comments, content, created) => {
    ...
    img.forEach((file) => {
        media += file.type === 'IMAGE' ? `<img class="card-img-top" src="${file.url}" alt="image"/>`:
                `<video class="card-img-top" controls><source src="${file.url}" type="video/mp4"></video>`;
    });
    ...
    return `
        <div class="card">
            <div class="card-profile p-2">
                ...
                <div>
                    <a href="/profile/${author_id}/" class="text-dark">
            ...
            <div class="card-body">
                ...
                <a href="/content/${id}" class="text-dark" id="comments-${id}">${no_of_comments} Comments</a>
        ...
        <script src="/static/content/image-slider.js"></script>
        <script src="/static/content/image-slider.css"></script>
    `;
}
